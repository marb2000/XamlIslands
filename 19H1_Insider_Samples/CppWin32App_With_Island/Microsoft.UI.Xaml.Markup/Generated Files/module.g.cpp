...
int32_t WINRT_CALL WINRT_GetActivationFactory(void* classId, void** factory) noexcept
{
    try
    {
        *factory = nullptr;
        ...
        if (requal(name, L"Microsoft.UI.Xaml.Markup.XamlApplication"))
        {
            *factory = winrt::detach_abi(winrt::make<winrt::Microsoft::UI::Xaml::Markup::factory_implementation::XamlApplication>());
            return 0;
        }

...
template <> struct guid_storage<Microsoft::UI::Xaml::Markup::IXamlApplicationFactory>{ static constexpr guid value{ 0xC2EDD3FE,0x96BA,0x5424,{ 0xB9,0x7B,0x87,0xAF,0x81,0x26,0xED,0xC8 } }; };

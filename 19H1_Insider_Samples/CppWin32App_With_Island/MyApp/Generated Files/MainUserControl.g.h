...
struct WINRT_EBO MainUserControl_base : implements<D, MyApp::IMainUserControl, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, composing, I...>,
...
{
    using base_type = MainUserControl_base;
    using class_type = MyApp::MainUserControl;
    using implements_type = typename MainUserControl_base::implements_type;
    ...
    {
        return L"MyApp.MainUserControl";
    }
    MainUserControl_base()
    {
...
struct WINRT_EBO MainUserControlT : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = MyApp::MainUserControl;
...
#if defined(WINRT_FORCE_INCLUDE_MAINUSERCONTROL_XAML_G_H) || __has_include("MainUserControl.xaml.g.h")

#include "MainUserControl.xaml.g.h"
...
{
    template <typename D, typename... I>
    using MainUserControlT = MainUserControl_base<D, I...>;
}

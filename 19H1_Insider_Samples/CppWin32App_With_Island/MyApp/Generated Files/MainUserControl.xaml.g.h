...
namespace winrt::MyApp::implementation
{
    ...
    struct MainUserControlT : public ::winrt::MyApp::implementation::MainUserControl_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename MainUserControlT::base_type;
        using base_type::base_type;
        using class_type = typename MainUserControlT::class_type;
    ...
    private:
        struct MainUserControl_obj1_Bindings;

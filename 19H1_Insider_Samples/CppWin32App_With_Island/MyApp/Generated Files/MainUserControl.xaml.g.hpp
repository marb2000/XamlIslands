...
namespace winrt::MyApp::implementation
{
    ...
    void MainUserControlT<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            Uri resourceLocator{ L"ms-appx:///MyApp/MainUserControl.xaml" };
            Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Nested);
        }
    }

    template <typename D, typename... I>
    void MainUserControlT<D, I...>::Connect(int32_t, IInspectable const&)
    {
        _contentLoaded = true;
    }

    template <typename D, typename ... I>
    void MainUserControlT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void MainUserControlT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector MainUserControlT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct MainUserControlT<struct MainUserControl>;
}

...
{
    using base_type = InternalUserControl_base;
    using class_type = SampleUserControl::InternalUserControl;
    using implements_type = typename InternalUserControl_base::implements_type;
    ...
    {
        return L"SampleUserControl.InternalUserControl";
    }
    InternalUserControl_base()
    {
...
struct WINRT_EBO InternalUserControlT : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = SampleUserControl::InternalUserControl;
...
#if defined(WINRT_FORCE_INCLUDE_INTERNALUSERCONTROL_XAML_G_H) || __has_include("InternalUserControl.xaml.g.h")

#include "InternalUserControl.xaml.g.h"
...
{
    template <typename D, typename... I>
    using InternalUserControlT = InternalUserControl_base<D, I...>;
}

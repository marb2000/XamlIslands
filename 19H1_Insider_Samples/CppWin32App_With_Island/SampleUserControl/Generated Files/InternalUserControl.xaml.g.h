...
namespace winrt::SampleUserControl::implementation
{
    ...
    struct InternalUserControlT : public ::winrt::SampleUserControl::implementation::InternalUserControl_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename InternalUserControlT::base_type;
        using base_type::base_type;
        using class_type = typename InternalUserControlT::class_type;
    ...
    private:
        struct InternalUserControl_obj1_Bindings;

...
namespace winrt::SampleUserControl::implementation
{
    ...
    void InternalUserControlT<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            Uri resourceLocator{ L"ms-appx:///SampleUserControl/InternalUserControl.xaml" };
            Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Nested);
        }
    }

    template <typename D, typename ... I>
    void InternalUserControlT<D, I...>::Connect(int32_t connectionId, IInspectable const& target)
    {
        switch (connectionId)
        {
        case 2:
    ...
    template <typename D, typename ... I>
    void InternalUserControlT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void InternalUserControlT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector InternalUserControlT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct InternalUserControlT<struct InternalUserControl>;
}

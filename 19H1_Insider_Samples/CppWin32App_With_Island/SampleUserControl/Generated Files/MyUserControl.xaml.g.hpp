...
namespace winrt::SampleUserControl::implementation
{
    ...
    void MyUserControlT<D, I...>::InitializeComponent()
    {
        ...
        {
            _contentLoaded = true;
            Uri resourceLocator{ L"ms-appx:///SampleUserControl/MyUserControl.xaml" };
            Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Nested);
        }
    }

    template <typename D, typename ... I>
    void MyUserControlT<D, I...>::Connect(int32_t connectionId, IInspectable const& target)
    {
        switch (connectionId)
        {
        case 2:

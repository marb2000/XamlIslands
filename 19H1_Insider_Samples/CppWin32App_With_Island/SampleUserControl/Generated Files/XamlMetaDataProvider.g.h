...
struct WINRT_EBO XamlMetaDataProvider_base : implements<D, Windows::UI::Xaml::Markup::IXamlMetadataProvider, I...>
{
    ...
    using class_type = SampleUserControl::XamlMetaDataProvider;
    ...
    {
        return L"SampleUserControl.XamlMetaDataProvider";
    }
};
...
{
    using instance_type = SampleUserControl::XamlMetaDataProvider;

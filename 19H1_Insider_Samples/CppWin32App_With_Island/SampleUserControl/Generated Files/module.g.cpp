...
int32_t WINRT_CALL WINRT_GetActivationFactory(void* classId, void** factory) noexcept
{
    try
    {
        *factory = nullptr;
        ...
        if (requal(name, L"SampleUserControl.InternalUserControl"))
        {
            *factory = winrt::detach_abi(winrt::make<winrt::SampleUserControl::factory_implementation::InternalUserControl>());
            return 0;
        }

...
{
    using base_type = MyNativeUserControl_base;
    using class_type = CppWinRTComponent::MyNativeUserControl;
    using implements_type = typename MyNativeUserControl_base::implements_type;
    ...
    {
        return L"CppWinRTComponent.MyNativeUserControl";
    }
    MyNativeUserControl_base()
    {
...
struct WINRT_EBO MyNativeUserControlT : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    using instance_type = CppWinRTComponent::MyNativeUserControl;
...
#if defined(WINRT_FORCE_INCLUDE_MYNATIVEUSERCONTROL_XAML_G_H) || __has_include("MyNativeUserControl.xaml.g.h")

#include "MyNativeUserControl.xaml.g.h"
...
{
    template <typename D, typename... I>
    using MyNativeUserControlT = MyNativeUserControl_base<D, I...>;
}

...
namespace winrt::CppWinRTComponent::implementation
{
    ...
    struct MyNativeUserControlT : public ::winrt::CppWinRTComponent::implementation::MyNativeUserControl_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename MyNativeUserControlT::base_type;
        using base_type::base_type;
        using class_type = typename MyNativeUserControlT::class_type;
    ...
    private:
        struct MyNativeUserControl_obj1_Bindings;

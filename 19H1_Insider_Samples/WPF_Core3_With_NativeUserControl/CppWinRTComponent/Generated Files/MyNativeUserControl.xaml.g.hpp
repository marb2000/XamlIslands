...
namespace winrt::CppWinRTComponent::implementation
{
    ...
    void MyNativeUserControlT<D, I...>::InitializeComponent()
    {
        if (!_contentLoaded)
        {
            _contentLoaded = true;
            Uri resourceLocator{ L"ms-appx:///CppWinRTComponent/MyNativeUserControl.xaml" };
            Application::LoadComponent(*this, resourceLocator, ComponentResourceLocation::Nested);
        }
    }

    template <typename D, typename... I>
    void MyNativeUserControlT<D, I...>::Connect(int32_t, IInspectable const&)
    {
        _contentLoaded = true;
    }

    template <typename D, typename ... I>
    void MyNativeUserControlT<D, I...>::DisconnectUnloadedObject(int32_t)
    {
        throw ::winrt::hresult_invalid_argument { L"No unloadable objects to disconnect." };
    }

    template <typename D, typename ... I>
    void MyNativeUserControlT<D, I...>::UnloadObject(DependencyObject const&)
    {
    ...
    template <typename D, typename... I>
    IComponentConnector MyNativeUserControlT<D, I...>::GetBindingConnector(int32_t, IInspectable const&)
    {
        return nullptr;
    }

    template struct MyNativeUserControlT<struct MyNativeUserControl>;
}

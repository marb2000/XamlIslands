...
struct WINRT_EBO XamlMetaDataProvider_base : implements<D, Windows::UI::Xaml::Markup::IXamlMetadataProvider, I...>
{
    ...
    using class_type = NativeWinRTComponent::XamlMetaDataProvider;
    ...
    {
        return L"NativeWinRTComponent.XamlMetaDataProvider";
    }
};
...
{
    using instance_type = NativeWinRTComponent::XamlMetaDataProvider;

...
namespace AppUIBasics
{
    ...
    public sealed partial class SectionPage : ItemsPageBase
    {
        ...
        private void SectionPage_Loaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            NavigationRootPage.SetNaviationViewHeader(sectionName, this.XamlRoot.Content);
        }

        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            base.OnNavigatedTo(e);
            sectionName = (string)e.Parameter;
